...
- **Do not repeat the same Japanese text string unless it appears multiple times in the image.**  
- **Only include translation notes when necessary to explain nuance** (e.g., cultural references, wordplay, ambiguous phrasing).  
- **Translate all extracted Japanese text without omission.**  
